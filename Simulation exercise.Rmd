...
```
So, as you can see the theoretical mean (`r mu`) and sample mean (`r SampleMean`) are very close.
...
As you can see standard deviation and variance in theory (`r sd` and `r Var`) and sample (`r sd_x` and `r Var_x`) are pretty close.
